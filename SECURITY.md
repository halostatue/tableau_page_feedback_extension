# TableauPageFeedbackExtension Security
...
TableauPageFeedbackExtension supports at most the three most recent versions of Elixir and
supported [Erlang/OTP versions][otp-versions].

As of April 2026, the support list is:
